...
//}
//
//static void listInsert(LIST *pList, NODE *pPrev, NODE *pNode)
//{
//	NODE *pNext;
//
//	if(pPrev == NULL)
...
//	NODE *pNext;
//
//	pNext = listFirst(pList);
//
//	while (pNext != NULL && pNext != pNode)
//	{
//		index++;
//		pNext = listNext(pNext);
//	}
//
//	if (pNext == NULL)
//	{
...
//
///*  
//Pop the last NODE in a list and return a pointer to that node.
//*/
...
//	}
//	node = pList->TAIL;
//	listDelete(pList, node);
//	return node;
//}
//
///*  
//Remove the first NODE from the list and return
