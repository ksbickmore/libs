...
//NODE *listPrev(NODE *pNode);
//int listCount(LIST *pList);
//void listAdd(LIST *pList, NODE *pNode);
//void listDelete(LIST *pList, NODE *pNode);
//int listFind(LIST *pList, NODE *pNode);
//NODE *listPop(LIST *pList);
//NODE *listGet(LIST *pList);
//extern NODE *	listFirst(LIST *pList);
//extern NODE *	listGet(LIST *pList);
//extern NODE *	listLast(LIST *pList);
//extern NODE *	listNStep(NODE *pNode, int nStep);
//extern NODE *	listNext(NODE *pNode);
//extern NODE *	listNth(LIST *pList, int nodenum);
//extern NODE *	listPrevious(NODE *pNode);
//extern int 		listCount(LIST *pList);
//extern int 		listFind(LIST *pList, NODE *pNode);
//extern void 	listAdd(LIST *pList, NODE *pNode);
//extern void 	listConcat(LIST *pDstList, LIST *pAddList);
//extern void 	listDelete(LIST *pList, NODE *pNode);
//extern void 	listExtract(LIST *pSrcList, NODE *pStartNode, NODE *pEndNode,
//	LIST *pDstList);
//extern void 	listFree(LIST *pList);
//extern void 	listInit(LIST *pList);
//extern void 	listInsert(LIST *pList, NODE *pPrev, NODE *pNode);
